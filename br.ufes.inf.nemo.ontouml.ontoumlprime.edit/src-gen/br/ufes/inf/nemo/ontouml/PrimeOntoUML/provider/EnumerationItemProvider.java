...
/**
 * This is the item provider adapter for a {@link br.ufes.inf.nemo.ontouml.PrimeOntoUML.Enumeration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EnumerationItemProvider
  extends UserDefinedDataTypeItemProvider
  implements
    ...
    IItemPropertySource
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_Enumeration_enumerationLiterals_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_Enumeration_enumerationLiterals_feature", "_UI_Enumeration_type"),
         PrimeOntoUMLPackage.Literals.ENUMERATION__ENUMERATION_LITERALS,
         true,
         false,
         false,
  ...
  public void notifyChanged(Notification notification)
  {
    ...
    {
      case PrimeOntoUMLPackage.ENUMERATION__ENUMERATION_LITERALS:
