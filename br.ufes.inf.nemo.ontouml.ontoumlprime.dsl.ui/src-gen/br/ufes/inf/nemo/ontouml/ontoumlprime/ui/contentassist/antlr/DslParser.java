		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getGeneralizationSetAccess().getIsCoveringAssignment_0(), "rule__GeneralizationSet__IsCoveringAssignment_0");
					put(grammarAccess.getGeneralizationSetAccess().getNameAssignment_2(), "rule__GeneralizationSet__NameAssignment_2");
					put(grammarAccess.getGeneralizationSetAccess().getSpecializedUniversalAssignment_4(), "rule__GeneralizationSet__SpecializedUniversalAssignment_4");
					put(grammarAccess.getGeneralizationSetAccess().getSpecializingUniversalsAssignment_6(), "rule__GeneralizationSet__SpecializingUniversalsAssignment_6");
					put(grammarAccess.getGeneralizationSetAccess().getSpecializingUniversalsAssignment_7_1(), "rule__GeneralizationSet__SpecializingUniversalsAssignment_7_1");
