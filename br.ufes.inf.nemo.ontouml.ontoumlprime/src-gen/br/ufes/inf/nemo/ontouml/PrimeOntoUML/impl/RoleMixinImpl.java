 ...
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.ontouml.PrimeOntoUML.impl.RoleMixinImpl#getMediation <em>Mediation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class RoleMixinImpl extends AntiRigidMixinUniversalImpl implements RoleMixin
{
  /**
  ...
  {
    return PrimeOntoUMLPackage.Literals.ROLE_MIXIN;
  }
    ...
    if (mediation != null && mediation.eIsProxy())
    {
      ...
      if (mediation != oldMediation)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, PrimeOntoUMLPackage.ROLE_MIXIN__MEDIATION, oldMediation, mediation));
      }
    }
    return mediation;
  }
  ...
  public NotificationChain basicSetMediation(Mediation newMediation, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PrimeOntoUMLPackage.ROLE_MIXIN__MEDIATION, oldMediation, newMediation);
  ...
  public void setMediation(Mediation newMediation)
  {
    if (newMediation != mediation)
    {
      ...
      eNotify(new ENotificationImpl(this, Notification.SET, PrimeOntoUMLPackage.ROLE_MIXIN__MEDIATION, newMediation, newMediation));
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PrimeOntoUMLPackage.ROLE_MIXIN__MEDIATION:
        if (mediation != null)
          msgs = ((InternalEObject)mediation).eInverseRemove(this, PrimeOntoUMLPackage.MEDIATION__TARGET, Mediation.class, msgs);
  ...
  public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass)
  {
    if (baseClass == ExternallyDependentUniversal.class)
    {
      ...
      {
        case PrimeOntoUMLPackage.ROLE_MIXIN__MEDIATION: return PrimeOntoUMLPackage.EXTERNALLY_DEPENDENT_UNIVERSAL__MEDIATION;
        default: return -1;
      }
    }
  ...
  public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass)
  {
    if (baseClass == ExternallyDependentUniversal.class)
    {
      ...
      {
        case PrimeOntoUMLPackage.EXTERNALLY_DEPENDENT_UNIVERSAL__MEDIATION: return PrimeOntoUMLPackage.ROLE_MIXIN__MEDIATION;
        default: return -1;
      }
    }
