 ...
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.ontouml.PrimeOntoUML.impl.ComplexDataTypeImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ComplexDataTypeImpl extends UserDefinedDataTypeImpl implements ComplexDataType
{
  ...
  {
    return PrimeOntoUMLPackage.Literals.COMPLEX_DATA_TYPE;
  }
  ...
  public EList<DataTypeAttribute> getAttributes()
  {
    if (attributes == null)
    {
      attributes = new EObjectContainmentWithInverseEList<DataTypeAttribute>(DataTypeAttribute.class, this, PrimeOntoUMLPackage.COMPLEX_DATA_TYPE__ATTRIBUTES, PrimeOntoUMLPackage.DATA_TYPE_ATTRIBUTE__COMPLEX_DATA_TYPE);
    }
    return attributes;
  }
  ...
  public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PrimeOntoUMLPackage.COMPLEX_DATA_TYPE__ATTRIBUTES:
