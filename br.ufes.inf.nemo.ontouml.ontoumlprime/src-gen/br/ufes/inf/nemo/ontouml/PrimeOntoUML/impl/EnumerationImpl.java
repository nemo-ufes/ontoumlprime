 ...
 * <ul>
 *   <li>{@link br.ufes.inf.nemo.ontouml.PrimeOntoUML.impl.EnumerationImpl#getEnumerationLiterals <em>Enumeration Literals</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class EnumerationImpl extends UserDefinedDataTypeImpl implements Enumeration
{
  ...
  {
    return PrimeOntoUMLPackage.Literals.ENUMERATION;
  }
  ...
  public EList<String> getEnumerationLiterals()
  {
    ...
    {
      enumerationLiterals = new EDataTypeEList<String>(String.class, this, PrimeOntoUMLPackage.ENUMERATION__ENUMERATION_LITERALS);
    }
